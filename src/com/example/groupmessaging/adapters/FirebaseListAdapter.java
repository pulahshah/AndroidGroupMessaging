    ...
    public FirebaseListAdapter(Query ref, Class<T> modelClass, int layout, Activity activity) {
        ...
        listener = this.ref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
            	...
            	Log.d(TAG, "Name:" + dataSnapshot.getName() + " " + dataSnapshot.getValue().toString());
            ...
            @Override
            public void onCancelled(com.firebase.client.FirebaseError error) {
            	Log.e("FirebaseListAdapter", "Listen was cancelled, no more updates will occur:" + error.getMessage());
            }
        });
    }
